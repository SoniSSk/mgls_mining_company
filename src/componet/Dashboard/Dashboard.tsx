    ...
    const constainers = [
        {
            ...
            text: "MGLS Mining Company is committed to responsible resource extraction, with decades of experience in global mining. Sustainability and environmental stewardship remain central to our mission.",
    ...
    return (
        <div className={styles.jjs}>
            ...
            <div className={styles.jj}>
                ...
                >
                    <div style={{ width: "500px " }}> MGLS Mining Compnay </div>
                </div>
            </div>
